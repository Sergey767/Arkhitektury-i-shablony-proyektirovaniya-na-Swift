...
class NewsViewController: UITableViewController {
    ...
    lazy var loggingProxy = NetworkServiceLoggingProxy(networkService: networkService)
    var postNews: VKNews?
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        loggingProxy.loadNews(token: Singleton.instance.token, completion: { [weak self] news, error in
